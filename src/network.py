...
class VehicleOutputsRecv(object):
    ...
    def process_recv_data(self, data, set_pipe):
        ...
        self.data_dict['nYaw'] = data[0]
        self.data_dict['gxVehicle'] = data[1]
        self.data_dict['gyVehicle'] = data[2]
        self.data_dict['vxVehicle'] = data[3]
        self.data_dict['vyVehicle'] = data[4]
        self.data_dict['aSlipF'] = data[5]
        self.data_dict['aSlipR'] = data[6]
        self.data_dict['aBodySlip'] = data[7]
        self.data_dict['aYaw'] = data[8]
        self.data_dict['rThrottlePedal'] = data[9]
        self.data_dict['rBrakePedal'] = data[10]
        self.data_dict['aSteeringWheel'] = data[11]
